const ShoppingIcon = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='80' height='80'>
      <defs>
        <path
          id='shoppingbag-path-1'
          d='M13.599 14.4v21.333a3.2 3.2 0 006.4 0V14.401h32v21.332a3.2 3.2 0 006.4 0V14.401h9.486l4.081 58.562C72.342 76.731 69.394 80 65.621 80H6.378C2.604 80-.345 76.731.033 72.963l4.081-58.562H13.6zM44.532 0c7.646 0 13.867 6.22 13.867 13.867v.533h-6.4v-.533c0-4.117-3.35-7.467-7.467-7.467H27.466C23.35 6.4 20 9.75 20 13.867v.533h-6.4v-.533C13.6 6.221 19.82 0 27.466 0z'
        />
